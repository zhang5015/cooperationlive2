...
/**
 * CooperationCategoryAffiliate form base class.
 *
 * @method CooperationCategoryAffiliate getObject() Returns the current form's model object
 *
 * @package    cooperation
 * @subpackage form
 ...
 */
abstract class BaseCooperationCategoryAffiliateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cooperation_category_affiliate[%s]');
