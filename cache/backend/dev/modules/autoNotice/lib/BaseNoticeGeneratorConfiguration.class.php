 ...
 */
abstract class BaseNoticeGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  'deleteNeverActivated' =>   array(    'label' => 'Delete never activated notices',  ),);
  }
  ...
  {
    return '%%is_activated%% <small>%%CooperationCategory%%</small> - %%company%% (<em>%%email%%</em>) is looking for a %%=position%% (%%location%%)';
  }
  ...
  {
    return 'Editing Notice "%%company%% is looking for a %%position%%"';
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'is_public' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Public?',),
      'is_activated' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Activated?',  'help' => 'Whether the user has activated the notice',  'or' => 'not',),
  ...
  {
    return 'BackendCooperationNoticeForm';
  }
  ...
  {
    return 'CooperationNoticeFormFilter';
  }
  ...
  {
    return 'retrieveBackendNoticeList';
  }
